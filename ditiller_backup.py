...
parser.add_argument('--teacher', default="res34", type=str)
...
teacher_path = "/home/aasadian/tofd/teacher/teacher_res34_seed_50.pth"
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        if correct / total > best_acc:
            ...
            torch.save(net.state_dict(), "/home/aasadian/tofd/saved/300_res8_teacher_res34_"+str(SEED)+ ".pth")
