...
parser.add_argument('--teacher', default="res20", type=str)
...
teacher_path = "/home/aasadian/tofd/teacher/teacher_res20.pth"
    ...
    for epoch in range(250):
        ...
        with torch.no_grad():
            ...
            if correct / total > best_acc:
                ...
                torch.save(net.state_dict(), "/home/aasadian/tofd/saved/res8_teacher_res20_"+str(SEED)+ ".pth")
